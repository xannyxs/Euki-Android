...
public class CalendarItem {
  ...
  public boolean hasContraception() {
    return this.mContraceptionPills != null
        || (this.mContraceptionDailyOther != null && this.mContraceptionDailyOther.size() > 0)
        || this.mContraceptionIUD != null
        || this.mContraceptionImplant != null
        || this.mContraceptionPatch != null
        || this.mContraceptionRing != null
        || this.mContraceptionShot != null;
  }
  ...
  public void setContraceptionLongTermOthers(
      List<ContraceptionLongTermOther> contraceptionLongTermOthers) {
  ...
  public CalendarItem copy() {
    ...
    calendarItem.mBleedingClotsCounter =
        new ArrayList<>(
            mBleedingClotsCounter != null
                ? mBleedingClotsCounter
    ...
    calendarItem.mSexualProtectionPregnancyCounter =
        new ArrayList<>(mSexualProtectionPregnancyCounter);
