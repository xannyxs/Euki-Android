...
public class CalendarWeekAdapter extends RecyclerView.Adapter {
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    if (holder instanceof CalendarDayHolder) {
      ...
      dayHolder.vClickable.setOnClickListener(
      ...
      CalendarItem calendarItem =
          mCalendarItems.get(DateUtils.toString(date, DateUtils.DateLongFormat));
      dayHolder.setup(
          date, true, calendarItem, mCalendarFilter, isSelectedDate, isToday, isPrediction);
    }
  }
  ...
  public void updateObjects(
      List<DayItem> items, Map<String, CalendarItem> calendarItems, CalendarFilter calendarFilter) {
