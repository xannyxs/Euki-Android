...
public class FutureAppointmentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            replaceFragment(FutureAppointmentFragment.newInstance(date), false);
        }
    }

    public static Intent makeIntent(Context context, Date date) {
        Intent intent = new Intent(context, FutureAppointmentActivity.class);
