...
public class MethodAdapter extends RecyclerView.Adapter<MethodAdapter.MethodHolder> {
    ...
    public MethodHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MethodHolder(view, mListener);
    }
    ...
    static class MethodHolder extends RecyclerView.ViewHolder {
        ...
        public MethodHolder(View itemView, MethodListener listener) {
            super(itemView);
            mListener = listener;
